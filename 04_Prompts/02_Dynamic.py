...
# ham ise dusri file mai bhi likh skte h aur json mai convert krke kahi bhi use kr skte hai
# in other file use tamplate.save("file_name"), and in this file use load_prompt("file_name")
